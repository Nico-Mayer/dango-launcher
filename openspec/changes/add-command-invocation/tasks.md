...
- [x] 8.2 Walk every scenario in the three spec files on Windows
  ...
  - Third finding, also fixed: nothing indicated that a slow command was working. Root search now shows a "Working..." line from the invocation until the first tree, a failure, or a hide, confirmed live with quit-application slowed to four seconds.
